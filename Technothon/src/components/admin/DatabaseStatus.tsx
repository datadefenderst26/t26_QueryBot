...
const mockDatabases: DatabaseInfo[] = [
  { id: '1', name: 'Production DB', engine: 'Connected', isConnected: true },
  { id: '2', name: 'Analytics DB', engine: 'Connected', isConnected: true },
  { id: '3', name: 'Staging DB', engine: 'Connected', isConnected: true },
  { id: '4', name: 'Legacy DB', engine: 'Disconnected', isConnected: false },
  { id: '5', name: 'Backup DB', engine: 'Disconnected', isConnected: false },
  { id: '6', name: 'Dev DB', engine: 'Connected', isConnected: true },
];
